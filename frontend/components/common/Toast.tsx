...
function Toast({ type, content, id, onClick }: ToastProps) {
  switch (type) {
    ...
    case 'danger':
      return (
        <div
          className="bg-red-200 border-l-4 border-red-700 text-red-700 px-4 py-2 max-w-xs z-20 mb-3"
          role="alert"
        >
          <span className="w-full flex flex-row flex-wrap">
    ...
    case 'warning':
      return (
        <div
          className="bg-yellow-200 border-l-4 border-yellow-700 text-yellow-700 px-4 py-2 max-w-xs z-20 mb-3"
          role="alert"
        >
          <span className="w-full flex flex-row flex-wrap">
