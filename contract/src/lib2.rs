...
pub struct TokenSeriesChildren {
...
pub struct TokenSeries {
    ...
    status: u8,
    banner: String,
    children_events_id: Vec::<Option<String>>,
}
...
impl Contract {
    ...
    pub fn children(&mut self,
        ...
        capacity: Vec::(Option<u32>),
            ...
            extra_event_metadata.capacity = capacity.unwrap().clone();
    ...
    pub fn new_event(
        ...
        includes: Vec::(Option<String>),
    ) -> TokenSeriesJson {
        let initial_storage_usage = env::storage_usage();
        let caller_id = env::signer_account_id();
        children_events_id = Vec::new();
